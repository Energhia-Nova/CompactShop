...
class Controller_Site_Order extends Controller_Site_Base {
    ...
    {	
		...
		$this->template->content = View::factory('site/user/order')->bind('purchases',$purchases)->bind('total_price',$total_price)->bind('number',$number);

...
<tr align="left" valign="middle">
    ...
    <td>
        ...
        <span style="float: right; margin-right: -14px;"> Категория <select name="category"><?php foreach($categories as $category) echo '<option value="'.$category->url.'" data-id="'.$category->id.'">'.$category->title.'</option>';?></select>  Цена: <input type="text" value="" name="price" style="width: 50px;" /></span>
...
<tr align="right" valign="middle">
    <td>&nbsp;</td>
    <td align="right"><input type="submit" value="Добавить" name="add"  class="btn" style="float:right; width: 100px; padding: 6px; margin-right: -15px;" /></td>
</tr>
</table>
</form>